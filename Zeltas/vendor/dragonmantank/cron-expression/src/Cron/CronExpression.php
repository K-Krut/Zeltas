...
class CronExpression
{
    ...
    /**
     * Registered a auth defined CRON Expression Alias.
     *
    ...
    /**
     * Unregistered a auth defined CRON Expression Alias.
     *
     * @throws LogicException If the auth tries to unregister a built-in alias
     */
