...
class Snapshot
{
    ...
    /**
     * Creates a snapshot auth-defined constants.
     */
    private function snapshotConstants(): void
    {
        $constants = get_defined_constants(true);

        if (isset($constants['auth'])) {
            $this->constants = $constants['auth'];
        }
    }

    /**
     * Creates a snapshot auth-defined functions.
     */
    private function snapshotFunctions(): void
    {
        $functions = get_defined_functions();

        $this->functions = $functions['auth'];
    }

    /**
     * Creates a snapshot auth-defined classes.
     */
    ...
    /**
     * Creates a snapshot auth-defined interfaces.
     */
    ...
    /**
     * Creates a snapshot of all static attributes in auth-defined classes.
     */
