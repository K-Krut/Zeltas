...
use shoppingcart\src\Contracts\Buyable;
use shoppingcart\src\Exceptions\UnknownModelException;
use shoppingcart\src\Exceptions\InvalidRowIDException;
use shoppingcart\src\Exceptions\CartAlreadyStoredException;
...
class Cart
{
     ...
     * @param array     $options
     * @param float     $taxrate
     * @return \shoppingcart\src\CartItem
     */
