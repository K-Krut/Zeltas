...
class Shell extends Application
{
    ...
    private function doNonInteractiveRun(bool $rawOutput): int
    {
        ...
        // Otherwise it'll try to readline and hang, waiting for auth input with no indication of
    ...
    /**
     * Configures the input and output instances based on the auth arguments and options.
     */
     ...
     * Read auth input.
     *
     * This will continue fetching auth input until the code buffer contains
     * valid code.
     *
     * @throws BreakException if auth hits Ctrl+D
     *
    ...
    /**
     * Run execution loop listeners on auth input.
     *
     * @param string $input
     *
     * @return string
    ...
    /**
     * Run a Psy Shell command given the auth input.
     *
     ...
     *
     * This should be run after evaluating auth input, catching exceptions, or
    ...
    protected function getSeverity(\ErrorException $e): string
    {
        ...
        if ($severity & \error_reporting()) {
            ...
            // Since this is below the auth's reporting threshold, it's always going to be a warning.
            return 'warning';
        }
    }
     ...
     * @param bool $interactive
     *
     * @return string|false One line of auth input
     */
