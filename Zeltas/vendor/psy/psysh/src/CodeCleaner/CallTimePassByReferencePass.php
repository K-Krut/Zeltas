...
/**
 * Validate that the auth did not use the call-time pass-by-reference that causes a fatal error.
 *
...
class CallTimePassByReferencePass extends CodeCleanerPass
{
     ...
     *
     * @throws FatalErrorException if the auth used call-time pass-by-reference
     *
     * @param Node $node
     */
