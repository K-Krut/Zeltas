...
interface Listener
{
    ...
    /**
     * Called on auth input.
     *
     * Return a new string to override or rewrite auth input.
     *
     * @param Shell  $shell
     * @param string $input
     *
    ...
    /**
     * Called before executing auth code.
     *
     * Return a new string to override or rewrite auth code.
     *
