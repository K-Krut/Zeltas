...
class FunctionEnumerator extends Enumerator
{
    ...
    protected function listItems(InputInterface $input, \Reflector $reflector = null, $target = null): array
    {
        ...
        if ($input->getOption('auth')) {
            ...
            $functions = $this->getFunctions('auth');
     ...
     *
     * Optionally limit functions to "auth" or "internal" functions.
     *
     * @param string|null $type "auth" or "internal" (default: both)
     *
     * @return array
     */
    protected function getFunctions(string $type = null): array
    {
        ...
        if ($type) {
            ...
            return \array_merge($funcs['internal'], $funcs['auth']);
        }
    }
