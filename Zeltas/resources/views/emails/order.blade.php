...
<head>
    ...
    <style>
        * {
            ...
            /*background-image: url("/images/patterns/background_main_2.png");*/
        }
...
<body
    style="margin: 0; padding: 0; -webkit-text-size-adjust: none;
    background-image: url('https://raw.githubusercontent.com/K-Krut/Zeltas/master/Zeltas/public/images/patterns/background_main_2.png');">
    ...
    <tr>
        <td>
            <table align="center" border="0" cellpadding="0" cellspacing="0" class="row row-4" role="presentation"
                   style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; margin-top: 50pt" width="100%">
                <tbody>
                <tr>
                    <td>
                        <table align="center" border="0" cellpadding="0" cellspacing="0" class="row-content stack"
                            ...
                            <tr>
                                <td class="column column-1"
                                    style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: center; vertical-align: top; padding-top: 0px; padding-bottom: 0px; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px;"
                                    width="100%">
                                            ...
                                            <td style="padding-left:20px;padding-right:20px;">
                                                <div style="font-family: sans-serif">
                                                    <div class="txtTinyMce-wrapper"
                                                         style="font-size: 14px; mso-line-height-alt: 16.8px; color: #000000; line-height: 1.2; font-family: Lato, Tahoma, Verdana, Segoe, sans-serif;">
                                                        <div class="logo">
                                                            <a href="#">
                        ...
                        <table align="center" border="0" cellpadding="0" cellspacing="0" class="row-content stack"
                            ...
                            <tr>
                                <td class="column column-1"
                                    ...
                                    width="100%">
                                    <div class="spacer_block" style="height:80px;line-height:80px;font-size:1px;"> 
                                    </div>
                                </td>
                            </tr>
                            </tbody>
                            ...
                            <tr>
                                <td class="column column-1"
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" class="image_block"
                                           ...
                                           width="100%">
                                        <tr>
                                            <td style="padding-bottom:45px;padding-left:0px;padding-top:20px;width:100%;padding-right:0px;">
                                                <div align="center" style="line-height:10px">
                                                    <img class="big"
                                                         src="https://raw.githubusercontent.com/K-Krut/Zeltas/master/Zeltas/public/images/patterns/footer-bg-800x-color-dodge.png"
                                                ...
                                                <tr>
                                                    <td style="padding:0 15px 0 15px;"><a
                                                            href="#" target="_blank"><img
                                                                alt="Facebook" height="75"
                                                                src="https://raw.githubusercontent.com/K-Krut/Zeltas/master/Zeltas/public/images/buttons/sm-facebook.png?raw=true"
                                                                style="display: block; height: auto; border: 0;"
                                                                title="facebook" width="75"/></a></td>
                                                    <td style="padding:0 15px 0 15px;"><a
                                                            href="#" target="_blank"><img
                                                                alt="Instagram" height="75"
                                                                src="https://raw.githubusercontent.com/K-Krut/Zeltas/master/Zeltas/public/images/buttons/sm-instagram.png?raw=true"
                                                                style="display: block; height: auto; border: 0;"
                                                                title="instagram" width="75"/></a></td>
                                                    <td style="padding:0 15px 0 15px;"><a
                                                            href="#" target="_blank"><img
                                                                alt="Instagram" height="75"
                                                                src="https://raw.githubusercontent.com/K-Krut/Zeltas/master/Zeltas/public/images/buttons/sm-telegram.png?raw=true"
                                                                style="display: block; height: auto; border: 0;"
                                                                title="instagram" width="75"/></a></td>
                                                    <td style="padding:0 15px 0 15px;"><a
                                                            href="#" target="_blank"><img
                                                                alt="Instagram" height="75"
                                                                src="https://raw.githubusercontent.com/K-Krut/Zeltas/master/Zeltas/public/images/buttons/sm-email.png?raw=true"
                                                                style="display: block; height: auto; border: 0;"
                                                                title="instagram" width="75"/></a></td>
                                                </tr>
                                            </table>
            ...
            <table align="center" border="0" cellpadding="0" cellspacing="0" class="row row-13" role="presentation"
                   style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; z-index: 999" width="100%">
                <tbody>
                <tr>
                    <td>
                        <table align="center" border="0" cellpadding="0" cellspacing="0" class="row-content stack"
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" class="text_block"
                                        ...
                                        <tr>
                                            <td style="padding-bottom:20px;padding-left:20px;padding-right:20px;padding-top:10px;">
                                                <div style="font-family: sans-serif">
                                                    <div class="txtTinyMce-wrapper"
                                                         style="font-size: 14px; mso-line-height-alt: 16.8px; color: #A08A7E; line-height: 1.2; font-family: Lato, Tahoma, Verdana, Segoe, sans-serif;">
                                                        <p style="margin: 0; font-size: 20px;"><span
                                                                style="font-size:20px;"><strong>Contact us</strong></span>
                                                        </p>
                                                    </div>
                                                </div>
                                            </td>
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" class="text_block"
                                        ...
                                        <tr>
                                            <td style="padding-bottom:10px;padding-left:10px;padding-right:10px;padding-top:10px;">
                                                <div style="font-family: sans-serif">
                                                    <div class="txtTinyMce-wrapper"
                                                         style="font-size: 12px; mso-line-height-alt: 14.399999999999999px; color: #A08A7E; line-height: 1.2; font-family: Lato, Tahoma, Verdana, Segoe, sans-serif;">
                                                        <p style="margin: 0; font-size: 20px;"><span
                                                                style="font-size:14px;">+38 954-955-12-48</span></p>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
                                            ...
                                            <td style="padding-bottom:30px;padding-left:10px;padding-right:10px;padding-top:10px;">
                                                <div style="font-family: sans-serif">
                                                    <div class="txtTinyMce-wrapper"
                                                         style="font-size: 12px; mso-line-height-alt: 14.399999999999999px; color: #A08A7E; line-height: 1.2; font-family: Lato, Tahoma, Verdana, Segoe, sans-serif;">
                                                        <p style="margin: 0; font-size: 20px;"><span
                                                                style="font-size:14px;">admin@zeltas.com</span>
                                                        </p>
                                                    </div>
                                                </div>
                                            </td>
